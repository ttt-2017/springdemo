...
<div id="tabs">
	<ul>
		...
		<!-- restful api-->
		<li><a href="#restful">Restful APIs</a></li>
	...
	<div id = "restful">
		...
		<p>
			See the <code>restful.demo</code> package for the @Controller code
		</p>
		<ul>
			<li>
				<a id="restfulApi" class="textLink" href="<c:url value="/greeting" />">Greeting </a>
			</li>
			<li>
				<a id="restfulApi2" class="textLink" href="<c:url value="/greeting?name=Fansy" />">Greeting Fansy!</a>
			</li>
		</ul>
	</div>
...
$(document).ready(function() {
	...
	$("form.textForm").submit(function(event) {
		...
		$.ajax({ type: "POST", url: form.attr("action"), data: "foo1", contentType: "text/plain", dataType: "text", success: function(text) { MvcUtil.showSuccessResponse(text, button); }, error: function(xhr) { MvcUtil.showErrorResponse(xhr.responseText, button); }});
		return false;
	});
